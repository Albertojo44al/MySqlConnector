...
namespace SideBySide
{
	public class Transaction : IClassFixture<TransactionFixture>
	{
		...
		public void SavepointNullName()
		{
			...
			Assert.Throws<ArgumentNullException>("name", () => transaction.Save(null));
			Assert.Throws<ArgumentNullException>("name", () => transaction.Release(null));
			Assert.Throws<ArgumentNullException>("name", () => transaction.Rollback(null));
		}
		...
		{
			using var transaction = m_connection.BeginTransaction();
			Assert.Throws<ArgumentException>("name", () => transaction.Save(""));
			Assert.Throws<ArgumentException>("name", () => transaction.Release(""));
			Assert.Throws<ArgumentException>("name", () => transaction.Rollback(""));
		}
